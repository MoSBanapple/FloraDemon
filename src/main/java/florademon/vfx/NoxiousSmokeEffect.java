...
//From BetterAnimation mod
public class NoxiousSmokeEffect extends AbstractGameEffect {
    private float x;
    ...
    public NoxiousSmokeEffect(float x, float y) {
        this.color = new Color(0.0F, 0.0F, 0.0F, 1.0F);
        this.color.r = MathUtils.random(0.5F, 0.6F);
        this.color.g = this.color.r + MathUtils.random(0.3F, 0.4F);
        this.color.b = 0.2F;
