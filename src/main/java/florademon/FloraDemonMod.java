...
@SpireInitializer
public class FloraDemonMod implements
    ...
    private static final Color cardColor = new Color(30f/255f, 105f/255f, 23f/255f, 1f);
    ...
    private static void loadModInfo() {
        Optional<ModInfo> infos = Arrays.stream(Loader.MODINFOS).filter((modInfo)->{
            ...
            return initializers.contains(FloraDemonMod.class.getName());
        }).findFirst();
        if (infos.isPresent()) {
            info = infos.get();
            modID = info.ID;
