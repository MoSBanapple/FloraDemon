...
import florademon.actions.FeedUponThemAction;
import florademon.character.FloraDemonCharacter;
import florademon.util.CardStats;

public class FeedUponThem extends BaseCard {
    public static final String ID = makeID(FeedUponThem.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new FeedUponThemAction(m, info, magicNumber));
