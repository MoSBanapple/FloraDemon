...
public class GrowIvy extends BaseCard {
    public static final String ID = makeID(GrowIvy.class.getSimpleName());
    ...
    public void onChoseThisOption() {addToTop(new ChannelAction(new PoisonIvy()));
    }
}
