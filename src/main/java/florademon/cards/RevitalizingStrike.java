...
import florademon.actions.TopOfDiscardPileToHandAction;
import florademon.character.FloraDemonCharacter;
import florademon.util.CardStats;

public class RevitalizingStrike extends BaseCard {
    public static final String ID = makeID(RevitalizingStrike.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new TopOfDiscardPileToHandAction(magicNumber));
    }
}
