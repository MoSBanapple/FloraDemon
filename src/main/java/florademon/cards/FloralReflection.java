...
import florademon.actions.FloralReflectionAction;
import florademon.actions.NurtureInHandAction;
import florademon.character.FloraDemonCharacter;
import florademon.util.CardStats;

public class FloralReflection extends BaseCard {
    public static final String ID = makeID(FloralReflection.class.getSimpleName());
