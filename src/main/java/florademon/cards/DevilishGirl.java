...
import florademon.actions.NurtureDrawPileToHandAction;
import florademon.actions.NurtureInHandAction;
import florademon.character.FloraDemonCharacter;
import florademon.util.CardStats;

public class DevilishGirl extends BaseCard {
    public static final String ID = makeID(DevilishGirl.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new NurtureDrawPileToHandAction(1, 1));
    }
}
