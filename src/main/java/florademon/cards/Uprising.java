...
public class Uprising extends BaseCard {
    public static final String ID = makeID(Uprising.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new UprisingAction(energyOnUse,upgraded,this.freeToPlayOnce));
    }
}
