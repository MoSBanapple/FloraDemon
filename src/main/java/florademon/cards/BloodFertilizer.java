...
public class BloodFertilizer extends BaseCard {
    public static final String ID = makeID(BloodFertilizer.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new NurtureInHandAction(magicNumber,1, !this.upgraded,false));
    }
}
