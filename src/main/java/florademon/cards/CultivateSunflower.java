...
public class CultivateSunflower extends BaseCard {
    public static final String ID = makeID(CultivateSunflower.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ShiningSunflower newPlant = new ShiningSunflower();
