...
public class ReturnToEarth extends BaseCard {
    public static final String ID = makeID(ReturnToEarth.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new NurtureInDrawPileAction(magicNumber,true));
    }
}
