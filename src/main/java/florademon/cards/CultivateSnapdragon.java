...
import florademon.orbs.BurningSnapdragon;
import florademon.util.CardStats;

public class CultivateSnapdragon extends BaseCard {
    public static final String ID = makeID(CultivateSnapdragon.class.getSimpleName());
