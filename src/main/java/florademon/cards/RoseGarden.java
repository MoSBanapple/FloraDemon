...
import florademon.powers.RoseGardenPower;
import florademon.util.CardStats;

public class RoseGarden extends BaseCard {
    public static final String ID = makeID(RoseGarden.class.getSimpleName());
    ...
    private static final int THORNS = 15;
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new ApplyPowerAction(p, p, new RoseGardenPower(p, magicNumber, 5)));
    }
}
