...
public class Overthrow extends BaseCard {
    public static final String ID = makeID(Overthrow.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p, p, new OverthrowPower(p, magicNumber)));
    }
}
