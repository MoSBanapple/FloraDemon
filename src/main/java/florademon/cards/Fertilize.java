...
public class Fertilize extends BaseCard {
    public static final String ID = makeID(Fertilize.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p, p, new FertilityPower(p, magicNumber)));
    }
}
